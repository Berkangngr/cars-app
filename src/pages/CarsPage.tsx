...
const carsBrandData: Record<string, string[]> = {
  ...
  CHEVROLET: ["", "SPARK", "SONIC", "CRUZE", "MALIBU", "CAMARO", "EQUINOX", "TRAX", "BLAZER", "SUBURBAN", "TAHOE", "COLORADO", "SILVERADO"],
  CITROEN: ["", "C1", "C3", "C3 AIRCROSS", "C4", "C4 CACTUS", "C5 AIRCROSS", "DS3", "DS4", "DS7"],
  DACIA: ["", "SANDERO", "LOGAN", "DUSTER", "Lodgy", "Dokker", "Jogger"],
  FIAT: ["", "500", "PANDA", "TIPO", "EGEA/PUNTO", "500X", "500L", "PULSAR", "DOBLO", "SCUDO"],
  FORD: ["", "FOCUS", "FIESTA", "MUSTANG", "KUGA", "ECOSPORT", "EDGE", "EXPLORER", "EXPEDITION", "RANGER", "TRANSIT"],
  HONDA: ["", "CIVIC", "ACCORD", "CR‑V", "JAZZ/FIT", "HR‑V", "ODYSSEY", "PILOT"],
  HYUNDAI: ["", "I10", "I20", "I30", "ELANTRA", "IONIQ", "KONA", "TUCSON", "SANTA FE", "PALISADE", "VENUE"],
  KIA: ["", "PICANTO", "RIO", "CEED", "STINGER", "SPORTAGE", "SORENTO", "EV6", "K5", "K7", "NIRO", "TELLURIDE"],
  MAZDA: ["", "MAZDA2", "MAZDA3", "MAZDA6", "CX‑3", "CX‑30", "CX‑5", "CX‑9", "MX‑5"],
  MERCEDES_BENZ: ["", "A‑CLASS", "B‑CLASS", "C‑CLASS", "CLA", "CLS", "E‑CLASS", "GLE", "GLC", "GLA", "G‑CLASS", "S‑CLASS", "SL", "SLC", "V‑CLASS", "EQC", "EQB", "EQE", "EQS"],
  MINI: ["", "HATCH/COOPER", "COUNTRYMAN", "CLUBMAN", "CONVERTIBLE", "ELECTRIC"],
  MITSUBISHI: ["", "SPACE STAR", "PHEV", "LANCER", "ASX/OUTLANDER SPORT", "OUTLANDER", "ECLIPSE CROSS"],
  NISSAN: ["", "MICRA", "NOTE", "LEAF", "QASHQAI", "X‑TRAIL", "JUKE", "KICKS", "PATROL", "PATHFINDER", "ARiYA"],
  OPEL: ["", "CORSA", "ASTRA", "INSIGNIA", "CROSSLAND", "MOKKA", "GRANDLAND", "COMBO", "VIVARO", "ZAFIRA"],
  PEUGEOT: ["", "108", "208", "2008", "308", "3008", "508", "RIFTER", "TRAVELLER", "E‑208", "E‑2008"],
  PORSCHE: ["", "911", "718 Boxster", "718 Cayman", "Cayenne", "Macan", "Panamera", "Taycan"],
  RENAULT: ["", "TWINGO", "CLIO", "MEGANE", "CAPTUR", "KADJAR", "ARKANA", "SCENIC", "KOLEOS", "TRAFIC"],
  SEAT: ["", "Mii", "IBIZA", "LEON", "ATECA", "ARONA", "TARRACO"],
  SKODA: ["", "CITIGO", "FABIA", "SCALA", "OCTAVIA", "SUPERB", "KAMIQ", "KAROQ", "KODIAQ"],
  SUBARU: ["", "IMPREZA", "XV", "FORESTER", "OUTBACK", "BRZ", "LEVORG"],
  SUZUKI: ["", "SWIFT", "BALENO", "VITARA", "IGNIS", "CROSSOVER", "S‑CROSS", "JIMNY", "S‑PULSE"],
  TESLA: ["", "MODEL S", "MODEL 3", "MODEL X", "MODEL Y", "CYBERTRUCK"],
  TOYOTA: ["", "YARIS", "COROLLA", "CAMRY", "PRIUS", "C‑HR", "RAV4", "HIGHLANDER", "LAND CRUISER", "GR86", "YARIS CROSS", "SEQUOIA"],
  VOLKSWAGEN: ["", "Polo", "Golf", "Passat", "Arteon", "T‑Roc", "Tiguan", "Touareg", "Touran", "Up!", "ID.3", "ID.4", "ID. Buzz"],
  VOLVO: ["", "S60", "V60", "XC40", "XC60", "XC90", "C40", "S90", "V90"],
  ACURA: ["", "ILX", "Integra", "TLX", "MDX", "RDX", "NSX"],
  BUGATTI: ["", "Chiron", "Divo", "Bolide", "Centodieci", "Veyron"],
  CHRYSLER: ["", "300", "Pacifica"],
  DODGE: ["", "Challenger", "Charger", "Durango", "Durango SRT Hellcat", "Ram 1500"],
  FERRARI: ["", "Roma", "F8 Tributo", "SF90", "Purosangue", "296 GTB"],
  ...
  LAND_ROVER: ["", "Discovery", "Defender", "Range Rover", "Range Rover Sport", "Velar"],
  LEXUS: ["", "UX", "NX", "RX", "GX", "LX", "IS", "ES", "LM"],
  LINCOLN: ["", "Corsair", "Aviator", "Nautilus", "Navigator", "Blackwood"],
  LOTUS: ["", "Emira", "Evija", "Eletre"],
  MASERATI: ["", "Ghibli", "Quattroporte", "Levante", "MC20"],
  MCLAREN: ["", "Artura", "GT", "720S", "765LT", "P1"],
  ROLLS_ROYCE: ["", "Phantom", "Ghost", "Wraith", "Cullinan", "Dawn", "Spectre"],
  XPENG: ["", "P7", "P5", "G6", "G9"],
  NIO: ["", "ET5", "ET7", "ES6", "ES8", "EC6"],
  ORA: ["", "Black Cat", "Good Cat"],
  MG: ["", "3", "MG5", "ZS", "HS", "MG4 EV"],
  OMODA: ["", "5", "C5", "E5"],
  JAECOO: ["", "7"],
  LYNK_CO: ["", "01", "02", "03", "05"],
  ZEEKR: ["", "001", "009"]
