...
const carsBrandData: Record<string, string[]> = {
  AİON:["","S"],
  ALFA_ROMEO: ["", "Giulia","Giulia Quadrifoglio", "145","146","147","155","156","159","164","166","33","75","Brera","GT","GTV","Spider", "Tonale", "4C", "Giulietta", "MiTo"],
  ANADOL:["","A","SV"],
  ARORA:["","S1"],
  ASTON_MARTIN: ["", "DB7","DB9","DBS","Vantage","Vanquish", "DB11","Virage","DBS Superleggera", "DBX", "Rapide", "Valhalla"],
  AUDI: ["", "A1","A2", "A3", "A4", "A5","A6", "A6 e-tron", "A7", "A8","E-Tron GT","R9","RS","S Serisi","TT","TTS","80 Serisi","90 Serisi","100 Serisi","Cabrio"], 
  BENTLEY: ["", "Continental GT", "Flying Spur", "Bentayga", "Mulsanne", "EXP 100"],
  BMW: ["", "1 SERIES", "2 SERIES", "3 SERIES", "4 SERIES", "5 SERIES", "6 SERIES", "7 SERIES", "8 SERIES","İ Serisi","M Serisi","Z Serisi"],
  BUİCK:["","Century","Le Sabre","Park Avenue","Regal","Riviera","Skylar"],
  BYD: ["", "Atto 3", "Seal", "Tang", "Han", "Yuan", "Dolphin", "Seal U"],
  CADILLAC: ["", "CTS","BLS","Brougham","DeVille","Eldorado","Fleetwood ","Seville","STS","CT4", "CT5", "ESCALADE", "XT4", "XT5", "XT6", "LYRIQ"],
  CHERY:["","Alia","Amulet","Chance","Kimo","Niche"],
  CHEVROLET: ["", "AVEO","CAMARO","CAPRİCE","EPİCA","EVANDA","IMPALA","LACETTİ","LUMİNA","MALİBU","MONTE CARLO","REZZO","SPARK", "SONIC", "CRUZE", "MALIBU", "EQUINOX", "TRAX", "BLAZER", "SUBURBAN", "TAHOE", "COLORADO",  "SILVERADO"],
  CHRYSLER: ["", "300 C","300 M","CONCORDE","CROSSFİRE","LHS","NEON","PT CRUİSER","SEBRİNA","STRATUS", "Pacifica"],
  CITROEN: ["","AMI","C-Elysée","C1","C2", "C3","e-C3","C3 PİCASSO", "C3 AIRCROSS", "C4","C4 GRAND PİCASSO","C4 PİCASSO","C4X","e-C4","e-C4X", "C4 CACTUS","C5","C6","C8","SAXO","XSARA","EVASİON","BX","AV","XANTİA","XM","ZX", "C5 AIRCROSS", "DS3", "DS4", "DS7"],
  CUPRA:["","BORN","LEON"],
  DACIA: ["", "SANDERO", "LOGAN", "DUSTER", "Lodgy", "Dokker", "Jogger","NOVA","SOLENZA"],
  DAEWOO:["","Chairman","NEXİA","NUBİRA","ESPERO","LANOS","LEGANZA","MATİZ","RACER","TİCO"],
  DAİHATSU:["","CUORE","MATERİA","SİRİON","APPLAUSE","CHARADE","COPEN","YRV"],
  DODGE: ["", "AVENGER","Challenger", "Charger","MAGNUM", "Durango", "Durango SRT Hellcat", "Ram 1500"],
  "DS AUTOMOBİLES":["","DS 3","DS 4","DS 5","DS 9"],
  FERRARI: ["", "Roma", "F8 Tributo", "SF90", "Purosangue", "296","360","430","458","488","550","575","599","812","CALİFORNİA","F12","F355","F8","FF","PORTOFİNO"],
  FIAT: ["", "124 SPİDER","ALBEA","500","BRAVA","126 BİS","COUPE","CROMA","IDEA","LİNEA","MAREA","MİRAFİORİ","MULTİPLA","PALİO", "PANDA", "TIPO", "EGEA","PUNTO", "500X", "500L", "PULSAR", "DOBLO", "SCUDO","REGATA","SEDİCİ","SİENA","STİLO","TEMPRA","TOPOLİNO","ULYSSE","UNO",""],
  FORD: ["","B-MAX","C-MAX","ESCORT","FUSİON","GALAXY","GRAND C-MAX","KA","MONDEO","S-MAX","TAURUS","COUGAR","CROWN VİCTORİA","FESTİVA","GRANADA","PROBE","SCORPİO","SİERRA","TAUNUS","THUNDERBİRD", "FOCUS", "FIESTA", "MUSTANG", "KUGA", "ECOSPORT", "EDGE", "EXPLORER", "EXPEDITION", "RANGER", "TRANSIT"],
  GEELY:["","ECHO","EMGRAND","FAMİLİA","FC"],
  HONDA: ["","CİTY","CR-Z","CRX","E","FV","INTEGRA","LEGEND","PRELUDE", "S2000","SHUTTE","STREAM","CIVIC", "ACCORD", "CR‑V", "JAZZ", "HR‑V", "ODYSSEY", "PILOT"],
  HYUNDAI: ["","ACCENT","ACCENT BLUE","ACCENT ERA","ATOS","COUPE","EXCEL","GENESİS","GETZ","GRANDUER" ,"I10", "I20","I20 ACTİVE","I20 N","I20 TROY","I30", "I40","IONİQ","IONİQ 6","İX20","MATRİX","S-COUPE","SONATA","TRAJET", "ELANTRA", "IONIQ", "KONA", "TUCSON", "SANTA FE", "PALISADE", "VENUE"],
  IKCO:["","SAMAND"],
  JIAYUAN:["","EIDOLA"],
  KIA: ["", "CAPITAL","CARENS","CARNIVAL","CERATO","MAGENTIS","OPIRUS","OPTIMA","PRİDE","PICANTO", "RIO", "CEED", "PRO CEED","SEPHIA","SHUMA","STINGER", "SPORTAGE", "SORENTO", "EV6", "K5", "K7", "NIRO", "TELLURIDE","VENGA",""],
  KUBA:["","CITY","M5"],
  LADA:["","KALINA","NOVA","PRIORA","SANARA","VAZ","VEGA"],
  MAZDA: ["", "MAZDA2", "MAZDA3", "MAZDA5","MAZDA6","MPV","MX","PREMACY","121","323","626","929","LANTIS","RX","XEDOS", "CX‑3", "CX‑30", "CX‑5", "CX‑9", "MX‑5"],
  "MERCEDES BENZ": ["", "A‑CLASS", "B‑CLASS", "C‑CLASS", "CLA", "CLS", "E‑CLASS", "AMG GT","CL","CLA","CLE","CLC","CLK","CLS","GLE", "GLC", "GLA", "G‑CLASS", "S‑CLASS", "SL", "SLC", "V‑CLASS", "EQC", "EQB", "EQE", "EQS","MAYBACH S","R-CLASS"],
  MINI: ["", "COOPER SD","COOPER S","HATCH/COOPER","JOHN COOPER","ONE","", "COUNTRYMAN", "COOPER CLUBMAN", "CONVERTIBLE", "ELECTRIC"],
  MITSUBISHI: ["", "ATTRAGE","COLT","GALANT","LANCER EVOLUTION","3000GT","CARISMA","SPACE STAR", "PHEV", "LANCER", "ASX/OUTLANDER SPORT", "OUTLANDER","ECPLISE", "ECLIPSE CROSS","SIGMA"],
  NISSAN: ["", "MICRA", "NOTE", "LEAF", "QASHQAI", "X‑TRAIL", "JUKE", "KICKS", "PATROL", "PATHFINDER", "ARiYA"],
  NIEVE:["","EVZOOM"],
  OPEL: ["","ADAM","AGILA","CALIBRA","CASCADA","CORSA","CORSA-E","GT-ROADSTAR","KAYETT","MERIVA","OMEGA","REKORT","SIGNUM","TIGRA","VECTRA",  "ASTRA", "INSIGNIA", "CROSSLAND", "MOKKA", "GRANDLAND", "COMBO", "VIVARO", "ZAFIRA"],
  PEUGEOT: ["", "106","107","108","205","206","206+","207","208","e-208","301","305","306","307","308","e-308", "2008", "405","406","407", "3008", "508","605","607","806","807","RCZ","1007", "RIFTER", "TRAVELLER", "E‑208", "E‑2008"],
  ...
  SKODA: ["", "CITIGO", "FABIA","FAVORIT","FELICIA","FORMAN","RAPID","ROOMSTAR", "SCALA", "OCTAVIA", "SUPERB", "KAMIQ", "KAROQ", "KODIAQ"],
  SMART:["","FORTWO","FORFOUR","ROADSTAR"],
  SUBARU: ["", "IMPREZA", "LEGACY","JUSTY","VIVIO","XV", "FORESTER", "OUTBACK", "BRZ", "LEVORG"],
  SUZUKI: ["","ALTO","SPLASH", "SX4","WAGON R","LIANA","MARUTI","SWIFT", "BALENO", "VITARA", "IGNIS", "CROSSOVER", "S‑CROSS", "JIMNY", "S‑PULSE"],
  TATA:["","INDICA","INDIGO","MARINA","VISTA","MANZA"],
  TESLA: ["", "MODEL S", "MODEL 3", "MODEL X", "MODEL Y", "CYBERTRUCK"],
  TOFAŞ:["","DOĞAN","KARTAL","MURAT","ŞAHİN","SERÇE"],
  TOYOTA: ["","AURIS","AVENSIS", "YARIS", "CARINA","CELICA","COROLLA","CORONA","CRESSIDA", "CAMRY","GT86","MR2", "PRIUS","SCARLET","SUPRA","TERCEL","URBAN CRUISER","VERSO", "C‑HR", "RAV4", "HIGHLANDER", "LAND CRUISER", "GR86", "YARIS CROSS", "SEQUOIA"],
  VOLKSWAGEN: ["", "BEETLE","BORA","CORRADO","EOS","ID.3","ID.7","JETTA","LUPO","Polo", "Golf", "Passat","PASSAT ALLTARCK","PASSAT VARIANT","PHATEON","SCIROCCO","SHARAN","TOURAN","UP CLUB","VW CC","VENTO","Arteon", "T‑Roc", "Tiguan", "Touareg", "Touran", "Up!", "ID.3", "ID.4", "ID. Buzz"],
  VOLVO: ["", "C30","C70","S40","S60","S70","S80","S90","S60","V40","V40 CROSS COUNTRY","V50","V60","V60 CROSS COUNTRY","V70","V90","V90 CROS COUNTRY","245","740","850","940","960", "XC40", "XC60", "XC90", "C40", "S90", "V90"],
  ...
  INFINITI: ["","Q30","Q50","G","I30", "M","Q60", "QX50", "QX55", "QX60", "QX80"],
  JAGUAR: ["", "DAIMLER","F-TYPE","S-TYPE","SOVEREİNG","X-TYPE","XJ","XJ6","XJR","XJS","XK8","XKR","XF", "XE", "F‑PACE", "E‑PACE", "I‑PACE"],
  JEEP: ["", "Renegade", "Compass", "Wrangler", "Grand Cherokee", "Gladiator", "Cherokee"],
  "LAND ROVER": ["", "Discovery", "Defender", "Range Rover", "Range Rover Sport", "Velar"],
  LEXUS: ["","CT","GS","IS","LC","LS","RC", "UX", "NX", "RX", "GX", "LX", "IS", "ES", "LM"],
  LINCOLN: ["", "CONTINENTAL","LS","TOWN CAR","Corsair", "Aviator", "Nautilus", "Navigator", "Blackwood"],
  LAMBORGHINI:["","AVENTADIR","GALLARDO","HURACAN","REVUELTO"],
  LANCIA:["","DELTA","THEMA","YPSILON","PHEDRA","THESIS"],
  LOTUS: ["", "Emira","ESPIT", "Evija", "Eletre"],
  MASERATI: ["","Cambiocorsa","GranCabrio","GranCabrio E","GranTurismo","GranTurismo E","2.24V","SPYDER", "Ghibli", "Quattroporte", "Levante", "MC20"],
  ...
  MG: ["", "F","MG3","MG4","MG7","3", "MG5", "ZS", "HS","ZR","ZT"],
  OMODA: ["", "5", "C5", "E5"],
  JAECOO: ["", "7"],
  LYNK_CO: ["", "01", "02", "03", "05"],
  ZEEKR: ["", "001", "009"]
