...
function Sidebar({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  return (
    ...
    >
      ...
      <List>
        <Divider />
        <ListItem button component={Link} to="/home" sx={{ px: 2.5 }}>
        ...
        <Divider />
        <ListItem button component={Link} to="/newRepair" sx={{ px: 2.5 }}>
        ...
        <Divider />
        <ListItem button component={Link} to="/customers" sx={{ px: 2.5 }}>
        ...
        <ListItem button component={Link} to="/cars" sx={{ px: 2.5 }}>
      ...
      >
        <ListItem button component={Link} to="/report/stockReport" sx={{ px: 2.5 }}>
...
export function SidebarWrapper({ children, setDrawerOpen }: { children: React.ReactNode, setDrawerOpen: () =>any }) {
